...
searchbtn.addEventListener("click", () => {
  ...
  filteredProducts.forEach((product) => {
    mobileCards1.innerHTML = `<div class="col-md-3 col-12 fw-bold p-2 border border-secondary-subtle rounded-2"">
...
while(i < products.length && i < 4){
  mobileCards1.innerHTML += `<div class="col-md col-sm-12 fw-bold p-2 mt-sm-4 border border-secondary-subtle rounded-2">
...
while(i < products.length && i < 8){
  mobileCards2.innerHTML += `<div class="col-md col-sm-12 fw-bold p-2 border border-secondary-subtle rounded-2">
    <img src="${products[i].image}" alt="" class="w-100 rounded-2" style="height: 190px">
    <div class="products-container">
      <h3 class="text-dark fs-4 pt-2 slug">${products[i].slug}</h3>
      <h3 class="text-dark fs-4 pt-2 products">${products[i].title}</h3>
