    ...
    onSubmit: async values => {
      try{
        ...
        if(res.ok){
          ...
          Cookies.set('userToken', tokenToSave, {expires: 7})
  ...
  return (
    <form onSubmit={formik.handleSubmit} className={styles.formContainer}>
      ...
      <div className={styles.signAsk}>
        <span>Already have an account?<Link to={"/login"} className={styles.signLink}>Login</Link></span>
      </div>
      <small>or</small>
